...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://otcbroker.space/auth" },
      { property: "og:image", content: "https://otcbroker.space/otc-broker-og.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sign in — OTC BROKER" },
      { name: "twitter:description", content: "Sign in or create your OTC BROKER trading account." },
      { name: "twitter:image", content: "https://otcbroker.space/otc-broker-og.png" },
    ],
    links: [{ rel: "canonical", href: "https://otcbroker.space/auth" }],
  }),
  component: AuthPage,
});
